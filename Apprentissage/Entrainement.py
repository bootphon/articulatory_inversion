...
def train_model(train_on ,test_on ,n_epochs ,delta_test ,patience ,lr=0.09, output_dim=13): #,norma=True):
    ...
    for speaker in speakers_in_lists:
        ...
        X_train_sp = np.load(os.path.join(fileset_path, "X_train" + speaker + ".npy"),allow_pickle=True)
        Y_train_sp = np.load(os.path.join(fileset_path, "Y_train_filtered" + speaker + ".npy"),allow_pickle=True)
        X_test_sp = np.load(os.path.join(fileset_path, "X_test" + speaker + ".npy"),allow_pickle=True)
