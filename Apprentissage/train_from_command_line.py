...
from Apprentissage.train_complete import train_model_complete
...
if __name__=='__main__':
    ...
    train_model_complete(test_on=test_on, n_epochs=n_epochs, loss_train=loss_train, patience=patience,
